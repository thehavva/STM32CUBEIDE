...
#define SMPLRT_DIV_REG 0x19		//This register specifies the divider from the gyroscope output rate used to generate the Sample Rate
#define GYRO_CONFIG_REG 0x1B	//This register is used to trigger gyroscope self-test and configure the gyroscopes’ full scale range
#define ACCEL_CONFIG_REG 0x1C	//This register is used to trigger accelerometer self test and configure the accelerometer full scale range.
...
void MPU6050_Read_Accel (void)
{
	...
	// Read 6 BYTES of data starting from ACCEL_XOUT_H register,starting from 0x3B
	...
	/*** Convert the RAW values into acceleration in '8g'
...
void MPU6050_Read_Gyro (void)
{
	...
	// Read 6 BYTES of data starting from GYRO_XOUT_H register,starting from 0x43
	...
	/*** Convert the RAW values into dps 65.5 LSB
	     we have to divide according to the Full scale value set in FS_SEL
...
void MPU6050_Read_Temp (void)
{
	...
	temp=(Temp_Raw /340.0 ) + 36.53; //Celcius values for temperature
}
/* USER CODE END 0 */
